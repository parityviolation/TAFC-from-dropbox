...
%
 ...
 %  spikes.params.thresh =    [-5.3897 -5.0999 -5.1816 -5.5274]; % for 'manual', set specific thresholds for each channel
    spikes.params.window_size  = 1.2;       % ms, width of a spike
    spikes.params.shadow = 0.2;            % ms, enforced dead region after each spike
    spikes.params.cross_time = 0.3;         % ms, alignment point for peak of waveform
