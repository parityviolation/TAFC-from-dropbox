...
cutoff = spikes.params.agg_cutoff;   % arbitrarily stop aggregation when overlap density is < 1% of main cluster density
...
tmin = size(spikes.waveforms,2)./spikes.params.Fs;  % minimum possible time btw spikes
