function spikes = ss_default_params(Fs, varargin )
 ...
 %  spikes.params.thresh =    [-5.3897 -5.0999 -5.1816 -5.5274]; % for 'manual', set specific thresholds for each channel
    ...
    % BA I think peaks are aligned to cross_time. So window around each
    % spike peak is [cross_time window_size-cross_time]
    ...
    % statistics - should these processor intensive statistics be displayed?
    spikes.params.display.show_gmm_overlap = 0;  % show simulation results of how much 2 clusters overlap
