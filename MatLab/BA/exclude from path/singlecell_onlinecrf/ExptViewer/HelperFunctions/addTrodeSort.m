function expt = addTrodeSort(expt)
%
...
% Add new TrodeSort
for trodeInd = 1:expt.info.probe.numtrodes
    expt.sort.trode(trodeInd).channels = expt.info.probe.trode.sites{trodeInd};
    expt.sort.trode(trodeInd).name = expt.info.probe.trode.names{trodeInd};
