function f = ft(response, tf, SAMPLERATE)
...
%	(MC usually uses Hz). Only the data within an integer number of periods 
%	are considered.
%
...
if tf == 0
	...
	expvec = exp(- (1:correctnsamples) *2*pi*1i*tf/SAMPLERATE );
