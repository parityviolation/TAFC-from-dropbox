...
for i = 1:handles.nActiveChannels
    if ~strcmp(get(handles.hTglHP(i),'Enable'),'off')
        ...
        handles = HPCallback(handles.hTglHP(i),eventdata,handles, 0);
    end  
end
guidata(hObject,handles);
dvHandles = guidata(handles.hDataViewer); 
...
for i = 1:handles.nActiveChannels
    if ~strcmp(get(handles.hTglHP(i),'Enable'),'off')
        ...
        handles = HPCallback(handles.hTglHP(i),1,handles, 0);
    end  
end
guidata(hObject,handles);
dvHandles = guidata(handles.hDataViewer); 
...
for i = 1:handles.nActiveChannels
    if ~strcmp(get(handles.hTglLP(i),'Enable'),'off')
        ...
        handles = LPCallback(handles.hTglLP(i),eventdata,handles, 0);
    end
end
guidata(hObject,handles);
dvHandles = guidata(handles.hDataViewer); 
...
for i = 1:handles.nActiveChannels
    if ~strcmp(get(handles.hTglLP(i),'Enable'),'off')
        ...
        handles = LPCallback(handles.hTglLP(i),1,handles, 0);
    end
end
guidata(hObject,handles);
dvHandles = guidata(handles.hDataViewer); 
...
for i = 1:handles.nActiveChannels
    if ~strcmp(get(handles.hTglThr(i),'Enable'),'off');
        ...
        handles = ThreshCallback(handles.hTglThr(i),eventdata,handles, 0);
    end
end
guidata(hObject,handles);
UpdateDataViewer(guidata(handles.hDataViewer));
