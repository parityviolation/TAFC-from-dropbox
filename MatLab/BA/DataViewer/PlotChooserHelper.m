...
% Set Default channels HPs and Thresholded
try % BA FIX this probably only works for DataViewer not ExptDataviewer 
    set(handles.hTglHP(r.PlotChooser.chnsHP),'Value',1,'BackgroundColor',[0.3 0.3 1])
set(handles.hTglThr(r.PlotChooser.chnsThresh),'Value',1,'BackgroundColor',[0.3 0.3 1])
