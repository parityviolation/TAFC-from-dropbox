...
switch string
    ...
    case '16 Channel 1x16'
       ind = find( ismember(RigDef.Probe.UserProbes,'16 Channel 1x16'));
       ChannelOrder = RigDef.ChannelOrder{ind};
    case '16 Channel 2x2'
       ind = find( ismember(RigDef.Probe.UserProbes,'16 Channel 2x2'));
       ChannelOrder = RigDef.ChannelOrder{ind};
    case '16 Channel 4x1'
       ind = find( ismember(RigDef.Probe.UserProbes,'16 Channel 4x1'));
       ChannelOrder = RigDef.ChannelOrder{ind};
