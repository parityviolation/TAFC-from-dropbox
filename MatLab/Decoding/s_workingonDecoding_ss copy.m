...
bmask = ismember(secondStim_fr,dp2.video.extremesFrames); %  not sure exactly why but there are different numbers of trials in these two sets of frames                                               % hack to avoid it
