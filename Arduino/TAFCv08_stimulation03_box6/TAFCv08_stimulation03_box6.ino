...
const int timeValvL = 58*2.3;                     // Calibrate valves for 2.58 ul with 50
const int timeValvR = 50*2.3;                 // Calibrate valves for 3.66 ul with 50
...
float condamp[] = {90,55,55}; // 30 ADC 10mW
