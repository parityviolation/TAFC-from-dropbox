...
const int timeValvL = 80;          //         // Calibrate valves for 2.58 ul with 50
...
void task()
{
  ...
  case 38: // premature_left_poke_in state
    ...
    case 209: // Premature Tone State
      errorTone(swError,durerrorTone);
    state = 210;
    strToPrint = String(state) + '\t' + String(millis());
    Serial.println(strToPrint);
    break;
...
void errorTone(int swError,int durTone)
{
