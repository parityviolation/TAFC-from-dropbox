...
const int prematuretimeOut =  18000 ;
...
const int timeValvL = 97*2.5;                     // Calibrate valves for 2.58 ul with 50
const int timeValvR = 75*2.5;                 // Calibrate valves for 3.66 ul with 50
