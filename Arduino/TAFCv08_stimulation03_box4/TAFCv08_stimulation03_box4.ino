...
const long ITI = 24000;
const long timeOut = 36000;
const long prematuretimeOut = 36000 ;
const long choiceDeadline = 5000; 
const int durerrorTone = 150;  // % used for premature too
const int durprematureerrorTone = 150;  // % used for premature too

const int timeValvL = 98*1;                     // Calibrate valves for 2.58 ul with 50
const int timeValvR = 128*1;                 // Calibrate valves for 3.66 ul with 50
...
float condamp[] = {100,55,55};
int condpulsefreq[] = {-1,10,10};
