...
//int timeValvL = 200; // Calibrate valves for 24 ul
//int timeValvR = 500; // Calibrate valves for 24 ul
int timeValvL = 40; // Calibrate valves for 48 ul
int timeValvR = 40; // Calibrate valves for 48 ul
