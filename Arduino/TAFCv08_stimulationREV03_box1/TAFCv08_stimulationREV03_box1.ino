...
//const int stimSetInd[] =  {0,1,1,1,2,2,2d,3,3,3,4,4,4,5,5,5,6,6,6,7};
...
const int timeValvL = 54*1;                     // Calibrate valves for 2.58 ul with 50
const int timeValvR = 52*1;                // Calibrate valves for 3.66 ul with 50
