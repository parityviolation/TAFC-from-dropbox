...
int timeOut = 6000; // (ms)
int rwdDelay = 0; // (ms)
int timeValvL = 55; // Calibrate valves for 2.5 ul
int timeValvR = 55; // Calibrate valves for 2.5 ul
int waitTarget = 5000;// Time (ms) the animal is required to wait at the center poke
int waitMin = 800;
int wait = waitMin;
int waitIncr = 10;
int waitDecr = 2;
