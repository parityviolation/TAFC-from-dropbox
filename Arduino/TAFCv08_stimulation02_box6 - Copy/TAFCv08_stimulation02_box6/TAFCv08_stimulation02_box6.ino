...
const int timeValvL = 80;      //BASS 1/9/2014 calibrated by eye :)               // Calibrate valves for 2.58 ul with 50
const int timeValvR = 73;                 // Calibrate valves for 3.66 ul with 50
