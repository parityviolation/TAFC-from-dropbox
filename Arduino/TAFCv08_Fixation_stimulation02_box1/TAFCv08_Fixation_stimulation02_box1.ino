...
const int timeValvL = 100;                     // Calibrate valves for 2.58 ul with 50
...
// Stimulation Block properties
 ...
 int  sizeInCondBlock[] = {3,0,0};
// Stimulation  properties
 float condamp[] = {48,35,25};          // percentage of Vcc (usually 5V) NOTE: ramp rate is not changed by condamp
 ...
 int onDuration[]  = {3000,0,0};  // time in ms NOTE: Duration time includes dur_rampUp time
