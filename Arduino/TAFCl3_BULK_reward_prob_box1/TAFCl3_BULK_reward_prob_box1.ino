...
int timeValvL = 45; // Calibrate valves for 2.533 ul with 60
int timeValvR = 45; // Calibrate valves for 2.538 ul with 60
const int rewardAmount[] =  {0,1,2};
int rewardNow = 0;
...
//     digitalWrite(ledC,LOW);
     if (stimCurrent>bound) {
       ...
       rewardNow = rewardAmount[random(sizeRewardAmount)];
