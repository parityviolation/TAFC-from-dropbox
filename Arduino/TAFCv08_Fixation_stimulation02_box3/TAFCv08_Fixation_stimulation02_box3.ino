...
// Stimulation  properties
 float condamp[] = {100,35,25};          // percentage of Vcc (usually 5V) NOTE: ramp rate is not changed by condamp
 int condpulsefreq[] = {15,-1,-1};      // use 25Hz se -1 if no pulse
