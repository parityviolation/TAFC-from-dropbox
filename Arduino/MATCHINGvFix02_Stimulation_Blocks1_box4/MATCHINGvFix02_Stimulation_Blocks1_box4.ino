...
// Task parameters
int a = 1;
int pHi =  50; // 0-100% Higher reward probability
int pLo =  10; // 0-100% Lower reward probability
int blockLenMin = 60;
int blockLenMax = 60; // this + blockLenMin
int ITI = 2200; // (ms)
int choiceDeadline = 1000; // (ms)
int timeOut = 6000; // (ms)
int rwdDelay = 0; // (ms)
int timeValvL = 43; // 
int timeValvR = 28; // 
...
int  binterleaveNoStimBlock = 1;                         // Block of non stimulated blocks between stimualted blocks
const int condblockSize =51; 
int sizeStimCondBlock =  condblockSize;
const int ncond =1;
int  stimulationSelector = 1;   // 1 - blocks only, 2 - interval (not blocks) 3 - probability (and blocks)
int condProbOfStimulation[] = {40,40,40} ;   // number between 0 and 100} NOTE for blocks only all number will be set to 100 automatically
int  sizeInCondBlock[] = {
  50,1,1};
// Stimulation  properties
float condamp[] = {
  55,55,55};   //53 for a867     //17 for 1013  // (30 for SERT) 39 10mW  20for 5mW 17 for 1.5mW percentage of Vcc (usually 5V) NOTE: ramp rate is not changed by condamp
