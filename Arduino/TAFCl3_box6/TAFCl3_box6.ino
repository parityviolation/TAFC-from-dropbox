...
int timeValvL = 67*2; // normal 70// Calibrate valves for 2.58 ul with 50
int timeValvR = 85*2; //nomral 70// Calibrate valves for 2.66 ul with 50
int stimCurrent = 1150;
int stimIncrement = 20;
/* */
// Internal variables
int state;
boolean valuePkC;
