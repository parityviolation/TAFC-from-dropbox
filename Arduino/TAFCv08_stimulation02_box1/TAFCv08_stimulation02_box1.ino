...
// Stimulation  properties
 float condamp[] = {70,35,25};          // percentage of Vcc (usually 5V) NOTE: ramp rate is not changed by condamp
 int condpulsefreq[] = {10,-1,-1};      // use 25Hz se -1 if no pulse
