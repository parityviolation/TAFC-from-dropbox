...
int pulseinterval = 33 ; //1000/pulsefrequency; 15Hz - 66 
long valPINPWM = 250; //150 = 2mW 120 = 1.8mW
long currentao = valPINPWM;
unsigned long lastStepAt = 0; //time
unsigned long lastPulseHigh = 0; // time
int stimulationDuration = 1500; //stimulation time in seconds
long rewardStart = 0;
boolean bSTIMLEFT = 1;
boolean bSTIMRIGHT = 0;
