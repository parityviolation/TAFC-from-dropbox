...
const int timeValvL = 50;
                    // Calibrate valves for 2.58 ul with 50
const int timeValvR = 50;
...
const int clMax =  10;
                       // number of correct answers to escape correction loop
...
// Stimulation Block properties
 ...
 const int condblockSize =12;                  
 const int ncond = 3;
 int  binterleaveNoStimBlock = 1;
                        // Block of non stimulated blocks between stimualted blocks
 int  sizeInCondBlock[] = {2,2,2};
// Stimulation  properties
 float condamp[] = {45,45,45}; 
 int condpulsefreq[] = {25,12,6};     //864 and 868 = {25,12,6} // 867 = {40,25,12}  45 5.5mW // use 25Hz se -1 if no pulse
// float condamp[] = {58,58,58};   //53 or 58 for a867 //45 for 864 and 868    //17 for 1013  // (30 for SERT) 39 10mW  20for 5mW 17 for 1.5mW percentage of Vcc (usually 5V) NOTE: ramp rate is not changed by condamp
...
//       Interval stimulation also does use condBlock since it is not tied to the trial structure of a task
 ...
 long minstimInterval = -1;
     // used for randome interval
 boolean brandstimInterval = 1 ;
