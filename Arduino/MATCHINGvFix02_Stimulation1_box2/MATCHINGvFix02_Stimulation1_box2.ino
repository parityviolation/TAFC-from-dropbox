...
boolean bdebug =0;
int selectStart=0; // set to 0 to start on LEft block 1 for right 
                       // -1 for random
...
int ITI = 9000; // (ms)
int choiceDeadline = 15000; // (ms)
int timeOut = 6000; // (ms)
int rwdDelay = 0; // (ms)
int timeValvL = 85; // Calibrate valves for 2.5 ul
int timeValvR = 120; // Calibrate valves for 2.5 ul
...
int onStateTrigger1[]  = {
  29,29,29};                           // This SECOND state number, -1 means this trigger will not be used
int offDelay[]  = {
  0,0,0};
int offStateTrigger[]  = {
