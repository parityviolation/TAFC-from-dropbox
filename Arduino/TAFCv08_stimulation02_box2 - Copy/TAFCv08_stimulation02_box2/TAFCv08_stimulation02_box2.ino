...
const int timeValvL = 73;                     // Calibrate valves for 2.58 ul with 50
const int timeValvR = 75;                 // Calibrate valves for 3.66 ul with 50
...
const int clThre = 2;                         // Threshold to activate correction loops, exclusive
