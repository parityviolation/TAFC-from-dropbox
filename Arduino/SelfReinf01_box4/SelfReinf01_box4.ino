...
int pulseinterval = 40 ; //1000/pulsefrequency; 25Hz - 40 - 15Hz - 66
long valPINPWM = 200; //150 = 3mW// 100 = 1.5mW
long currentao = valPINPWM;
unsigned long lastStepAt =0; //time
unsigned long lastPulseHigh = 0; // time
int stimulationDuration = 500; //stimulation time in milliseconds
long rewardStart = 0;
boolean bSTIMLEFT = 0;
