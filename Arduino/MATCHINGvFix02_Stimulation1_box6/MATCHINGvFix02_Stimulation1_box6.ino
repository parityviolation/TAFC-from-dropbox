...
int blockLenMin = 5000;
int blockLenMax = 5000; // this + blockLenMin
int ITI = 9000; // (ms)
int choiceDeadline = 60000; // (ms)
int timeOut = 6000; // (ms)
int rwdDelay = 0; // (ms)
int timeValvL = 80; //70 4uL// 60 Calibrate valves for 2.0ul
int timeValvR = 80; //70 4uL// 60 Calibrate valves for 2.0 ul
