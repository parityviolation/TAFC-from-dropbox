...
const int prematuretimeOut =  20000 ;
const int choiceDeadline = 5000; 
const int durerrorTone = 150;  // % used for premature too
const int durprematureerrorTone = 1000;  // % used for premature too

const int timeValvL = 58*3;                     // Calibrate valves for 2.58 ul with 50
const int timeValvR = 72*3;                 // Calibrate valves for 3.66 ul with 50
