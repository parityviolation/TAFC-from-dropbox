...
// Analogout setup
int condaoPin[] = {
  10,10,10};                       // output pin supporting PWM
...
//analogWrite(10, 255); 
  //Setup AO
  TCCR2B = (TCCR2B & 0xF8) | 0x01;                     // set Timer 1 to 32kHz //http://sobisource.com/?p=195 
...
{ 
  if ( condthisrampstep[thisCondIndex] != 0){
    ...
    analogWrite(condaoPin[thisCondIndex], condaoval[thisCondIndex]);
    //    Serial.println();
  } 
}
