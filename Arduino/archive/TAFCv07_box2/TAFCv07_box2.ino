...
//const double initSet[] = {0.2, 0.35, 0.42, 0.46, 0.48, 0.52, 0.54, 0.58, 0.65, 0.8};
const double initSet[] = {0.2, 0.35, 0.46, 0.48, 0.52, 0.54, 0.65, 0.8};
...
const int timeValvL = 120; // Calibrate valves for 3.035 ul with 50
const int timeValvR = 100; // Calibrate valves for 3.027 ul with 50
