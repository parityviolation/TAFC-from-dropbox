...
int stimSet[] =  {600,1050,1950,2400};
//int stimSet[] =  {1260,1050,1950,1740};
...
int timeValvL = 70; // Calibrate valves for 2.8 ul with 75
int timeValvR = 70; // Calibrate valves for 2.834 ul with 60
