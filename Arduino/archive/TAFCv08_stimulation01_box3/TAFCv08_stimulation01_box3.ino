...
const boolean bredrawOnPM = 1;                    // SET TO 1 for performance Set to 0 for training when you don't want a new stimulus after premature
...
// Stimulation  properties
 float condamp[] = {45,0,0};          // percentage of Vcc (usually 5V) NOTE: ramp rate is not changed by condamp
 ...
 int onDuration[]  = {4000,0,0};  // time in ms NOTE: Duration time includes dur_rampUp time
 int conddur_rampDn[] = {1,1,1};     // ms ramp rate: define as the time ramp from PWM = 255 to 0  
// EITHER (Triggered Stimulation)
 int onStateTrigger[]  = {56,-1,-1};                           // This can be any state number, -1 means this trigger will not be used
 int offDelay[]  = {0,0,0};
