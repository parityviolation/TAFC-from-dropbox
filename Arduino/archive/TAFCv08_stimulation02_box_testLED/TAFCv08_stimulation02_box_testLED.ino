...
// Stimulation Block properties
 ...
 int  sizeInCondBlock[] = {1,1,1};
// Stimulation  properties
 float condamp[] = {100,17,17};  //17 1.5mW //55 7mW// 44 5mW 70 10mW        // percentage of Vcc (usually 5V) NOTE: ramp rate is not changed by condamp
