...
int stimSet[] = {7};
int stimSetInd[] = {0,3,3,4,4,4,5,5,6,7};
int sizestimSetInd = 1;
int bound = 700;
int ITI = 900;
int timeOut = 1200;
int choiceDeadline = 500;
...
int clCredit = 7;
// Decrement in error counter for each correct trial (but never goes negative)
