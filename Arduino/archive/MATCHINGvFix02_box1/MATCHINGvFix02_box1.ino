...
// Task parameters
int a = 1;
int pHi =  10; // 0-100% Higher reward probability
int pLo =  90; // 0-100% Lower reward probability
int blockLenMin = 50;
...
int timeOut = 6000; // (ms)
int rwdDelay = 0; // (ms)
int timeValvL = 40; // Calibrate valves for 2.5 ul
int timeValvR = 40; // Calibrate valves for 2.5 ul
