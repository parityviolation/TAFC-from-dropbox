...
long delayTn1Current = 0;
long delayTn2Min = 100;
long delayTn2Mean = 100;
...
void updateParams() {
  if (!Beginner) {
    ...
    if (wasPatient) {
      ...
      delayTn1Current -= 10;
      delayTn1Current = max(delayTn1Current, 0);
      delayTn2Min -= 10;
    ...
    timeToFakePoke = pow(beginnerCounter/10,3)*1000 + 1000; // conversion from beginner counter to time to fake poke
